      ...
      <>
        ...
        <div className="min-h-screen flex items-center justify-center px-4"
          ...
          <div className="text-center max-w-sm">
            ...
            <h1 className="font-mono font-black text-white mb-2 tracking-tight text-2xl">account created.</h1>
            <p className="font-mono text-xs text-slate-500 mb-8">redirecting to sign in...</p>
            <Link href="/login"
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-white hover:bg-slate-100 text-black font-mono font-semibold text-sm rounded-lg transition-all">
      ...
      <div className="min-h-screen flex flex-col" style={{ background: "#010d1a" }}>
        ...
        <div className="flex-1 flex items-center justify-center px-4 py-16">
          <div className="w-full max-w-sm">
            ...
            {/* Header */}
            <div className="mb-8">
              <p className="font-mono text-xs text-slate-600 tracking-[0.2em] uppercase mb-3">get started free</p>
              <h1 className="font-mono font-black text-white tracking-tight mb-2"
                  style={{ fontSize: "clamp(1.6rem, 4vw, 2.2rem)", lineHeight: 1.1 }}>
                create account
              </h1>
              <div className="flex flex-wrap gap-x-3 gap-y-1 font-mono text-xs text-slate-600 mt-3">
                {["52 tools", "compiled binary", "BYOK", "offline-capable"].map((f) => (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="block font-mono text-xs text-slate-500 mb-2 uppercase tracking-wider">name</label>
              ...
              <div>
                <label className="block font-mono text-xs text-slate-500 mb-2 uppercase tracking-wider">email</label>
                <div className="relative">
              ...
              <div>
                <label className="block font-mono text-xs text-slate-500 mb-2 uppercase tracking-wider">password</label>
                <div className="relative">
              ...
              <div>
                <label className="block font-mono text-xs text-slate-500 mb-2 uppercase tracking-wider">confirm password</label>
                <div className="relative">
                  <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-600" />
                  <input
                    type="password"
